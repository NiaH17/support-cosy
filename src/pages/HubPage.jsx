...
export default function HubPage({ session }) {
  ...
  const ACTIONS = [
    ...
    },
    {
      id: 'assistance',
      route: '/assistance',
      label: "Nouvelle demande d'assistance",
      subtitle: 'Soumettre un ticket au support technique',
      bg: 'bg-pink-50', color: 'text-brand-pink',
    ...
    },
    {
      ...
      route: '/mes-demandes',
      label: 'Mes demandes',
      subtitle: 'Suivre & répondre à vos tickets ouverts',
      bg: 'bg-purple-50', color: 'text-brand-purple',
        ...
        {role === 'admin' && (
          <div className="pt-2">
            <button onClick={() => navigate('/admin')}
              ...
              <div className="flex-1 text-left">
                <p className="font-semibold text-brand-navy">Admin — Toutes les demandes</p>
                <p className="text-sm text-gray-500 mt-0.5">Triage, réponses & gestion des tickets</p>
              </div>
              <svg className="w-4 h-4 text-gray-300 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
